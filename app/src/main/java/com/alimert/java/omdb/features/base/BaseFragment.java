...
import com.alimert.java.omdb.injection.component.ConfigPersistentComponent;
import com.alimert.java.omdb.injection.component.DaggerConfigPersistentComponent;
import com.alimert.java.omdb.injection.component.FragmentComponent;
        ...
        if (componentsArray.get(fragmentId) == null) {
            ...
            configPersistentComponent =
                    DaggerConfigPersistentComponent.builder()
                            .appComponent(MvpApplication.get(getActivity()).getComponent())
                            .build();
