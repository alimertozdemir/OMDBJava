...
import com.alimert.java.omdb.features.detail.DetailMvpView;
import com.alimert.java.omdb.features.detail.DetailPresenter;
...
public class DetailPresenterTest {
    ...
    public void getPokemonDetailReturnsPokemon() throws Exception {
        ...
        detailPresenter.getMovieDetail(anyString());
